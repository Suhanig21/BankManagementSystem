...
public class RepaymentScheduleController {
    ...
    @PutMapping("/pay")
    public ResponseEntity<?> processPayment(@RequestParam Long loanId,
                                            @RequestParam int installmentNumber,
                                            @RequestParam double amountPaid,
                                            @RequestParam String paymentDate) {
        boolean success = repaymentScheduleService.processPayment(loanId, installmentNumber, amountPaid, paymentDate);
        if (success) {
